...
class Home(WebHome):
    ...
    def web_login(self, redirect=None, **kw):
        ...
        orientation = conf_param.get_param('og-app-custom-login-page.orientation')
        image = conf_param.get_param('og-app-custom-login-page.image')
        url = conf_param.get_param('og-app-custom-login-page.url')
        background_type = conf_param.get_param('og-app-custom-login-page.background')
        if background_type == 'color':
            values['bg'] = ''
            values['color'] = conf_param.sudo().get_param(
                'og-app-custom-login-page.color')
        ...
        if orientation == 'right':
            response = request.render('og-app-custom-login-page.login_template_right',
                                      values)
        elif orientation == 'left':
            response = request.render('og-app-custom-login-page.login_template_left',
                                      values)
        elif orientation == 'middle':
            response = request.render('og-app-custom-login-page.login_template_middle',
                                      values)
        else:
